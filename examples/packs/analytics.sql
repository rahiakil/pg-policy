...
SELECT agent_policy.upsert_policy('pack_analytics_writes', $apl$
forbid
  principal agent "*"
...
SELECT agent_policy.upsert_policy('pack_analytics_need_tenant', $apl$
forbid
  principal agent "*"
  action tool "execute_sql"
...
SELECT agent_policy.upsert_policy('pack_analytics_select_ok', $apl$
permit
  principal agent "*"
  action tool "execute_sql"
...
SELECT agent_policy.upsert_policy('pack_analytics_explain_ok', $apl$
permit
  principal agent "*"
...
SELECT agent_policy.upsert_policy('pack_analytics_list_ok', $apl$
permit
  principal agent "*"
...
SELECT agent_policy.upsert_policy('pack_analytics_tight_rows', $apl$
guide
  principal agent "*"
  action tool "execute_sql"
