...
SELECT agent_policy.upsert_policy('pack_baseline_ddl', $apl$
forbid
  principal agent "*"
...
SELECT agent_policy.upsert_policy('pack_baseline_copy', $apl$
forbid
  principal agent "*"
  action tool "execute_sql"
...
SELECT agent_policy.upsert_policy('pack_baseline_sql_guide', $apl$
guide
  principal agent "*"
  action tool "execute_sql"
...
SELECT agent_policy.upsert_policy('pack_baseline_export_quota', $apl$
forbid
  principal agent "*"
