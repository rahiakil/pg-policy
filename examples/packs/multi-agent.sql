...
SELECT agent_policy.upsert_policy('pack_ma_researcher_sql', $apl$
permit
...
SELECT agent_policy.upsert_policy('pack_ma_researcher_no_mail', $apl$
forbid
  principal agent "crew:researcher"
...
SELECT agent_policy.upsert_policy('pack_ma_writer_no_sql', $apl$
forbid
...
SELECT agent_policy.upsert_policy('pack_ma_writer_mail', $apl$
permit
  principal agent "crew:writer"
  action tool "send_email"
...
SELECT agent_policy.upsert_policy('pack_ma_writer_mail_block', $apl$
forbid
  principal agent "crew:writer"
  action tool "send_email"
...
SELECT agent_policy.upsert_policy('pack_ma_critic_read', $apl$
permit
...
SELECT agent_policy.upsert_policy('pack_ma_supervisor_quota', $apl$
forbid
