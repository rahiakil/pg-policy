...
SELECT pg_agent_policy.upsert_policy('pack_devops_live_ddl', $apl$
forbid
  principal agent "*"
...
SELECT pg_agent_policy.upsert_policy('pack_devops_writes', $apl$
forbid
  principal agent "*"
  action tool "execute_sql"
...
SELECT pg_agent_policy.upsert_policy('pack_devops_explain', $apl$
permit
  principal agent "*"
...
SELECT pg_agent_policy.upsert_policy('pack_devops_select', $apl$
permit
  principal agent "*"
  action tool "execute_sql"
...
SELECT pg_agent_policy.upsert_policy('pack_devops_guide', $apl$
guide
  principal agent "*"
  action tool "execute_sql"
