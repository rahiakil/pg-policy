...
SELECT agent_policy.open_session('sess-export-demo', 'agent', 'research_bot');
...
SELECT agent_policy.evaluate('agent','research_bot','tool','export_csv','*','*','{}'::jsonb,'sess-export-demo');
SELECT agent_policy.evaluate('agent','research_bot','tool','export_csv','*','*','{}'::jsonb,'sess-export-demo');
SELECT agent_policy.evaluate('agent','research_bot','tool','export_csv','*','*','{}'::jsonb,'sess-export-demo');
